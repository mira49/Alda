...
<body>
	...
	<div id="corpsDa">
		...
		<div class="infoperso ">
			...
			<br><br>
					<label> Image 1 : </label>
			            <a href="<c:url value="${ current_annonce.image1 }"/>">Show</a><br><br>
			        <label> Image 2 : </label>                 
			        	<a href="<c:url value="${ current_annonce.image2 }"/>">Show</a>
			<c:if test="${ !empty current_annonce.image3 }">
					<br><br>
			        <label> Image 3 : </label>                 
			        	<a href="<c:url value="${ current_annonce.image3 }"/>">Show</a>
					</c:if>
