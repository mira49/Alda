		...
		<div id="body-application">
			...
			<form method="post" action="add_Announcement">
				<fieldset id="Field">
					...
					<input type="number" id="postal_code" name="postal_code" size="20" maxlength="5"
						required="" value=""}> </input> <br />
					...
					<input type="file" required="" id="picture2" name="picture2" /><a >Click here to Add a picture</a>
										<br />
