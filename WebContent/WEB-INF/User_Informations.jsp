			...
			<form role="form" method="post" action="user_Informations">
				<fieldset id="Field">
					...
					<label> Email : </label> <input type="text" name="email"
						value=${sessionScope.user.email } required autofocus disabled>
					<br> <br> <label> Name : </label><input name="Name"
						value=${sessionScope.user.name} ><br> <br> <label>
						FirstName : </label><input type="text" name="FirstName"
						value=${sessionScope.user.firstName} ><br> <br>
					<label> Adress : </label>
					<textarea type="text" name="Address"
						value=${sessionScope.user.address} > </textarea>
					<br> <label> Phone : </label><input type="text" name="Phone"
						value=${sessionScope.user.phone}  ><br> <br>
