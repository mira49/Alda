		...
		<div class="infoperso ">
			<form role="form" method="post" action="add_Announcement"
				...
				<fieldset id="Field">
					...
					<br><br>
					<label> Image 1 : </label>
			            <a href="<c:url value="/images/${ current_annonce.image1 }"/>">Voir</a><br><br>
			        <label> Image 2 : </label>                 
			        	<a href="<c:url value="/images/${ current_annonce.image2 }"/>">Voir</a>
			<c:if test="${ !empty current_annonce.image3 }">
					<br><br>
			        <label> Image 3 : </label>                 
			        	<a href="<c:url value="/images/${ current_annonce.image3 }"/>">Voir</a>
					</c:if>
										</c:if>
