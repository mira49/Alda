...
public class Add_Announcement extends HttpServlet {
		  ...
		  try {
		        ...
		        for (FileItem item : items) {
		            if (item.isFormField()) {
		                ...
		                case "Description": 	annonce.setDescription(valeurChamp);
		                         break;
		                case "postal_code": 	annonce.setPostal_code(Integer.parseInt(valeurChamp));
		                         break;
		                case "Price":  			annonce.setPrice(Integer.parseInt(valeurChamp));
		                         break;
		                case "Surface": 		annonce.setSurface(Integer.parseInt(valeurChamp));
		                         break;
		                case "Town": 			annonce.setTown(valeurChamp);
		                         break;
		                case "Name": 			annonce.setName(valeurChamp);
		                         break;
		                default: 
		                         break;
		            }
		                ...
		                case "picture3": annonce.setImage3(nomFichier);
		                         break;
		                case "picture2":  annonce.setImage2(nomFichier);
		                         break;
		                case "picture1": annonce.setImage1(nomFichier);
		                         break;
    ...
    private String validationImage( HttpServletRequest request, String chemin , String nom,  InputStream co, String nomChamp) throws FormValidationException {
        /*
