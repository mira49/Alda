	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session.getAttribute("admin") == null) {
			...
			if ((User) session.getAttribute("user") != null) {
				user.setFactor(request.getParameter("factor_lower_price") + " ; "
			...
			/*
			 * if( select_option != null){ if
			 * (select_option.equals("lower_Price")) { announcement =
			 * dao.findByLowerPrice(sql_request); } else if
			 * (select_option.equals("higher_Price")) { announcement =
			 * dao.findByHigherPrice(sql_request); } else if
			 * (select_option.equals("Location")) { announcement =
			 * dao.findByPostalCode(sql_request); } }
			 */
